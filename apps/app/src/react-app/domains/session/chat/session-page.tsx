...
import { BarChart3, Columns2, FileText, Globe, Mic2, PenLine, Settings2, X, Zap } from "lucide-react";
...
export function SessionPage(props: SessionPageProps) {
  ...
  const openBrowserUrlControlAction = useMemo<OpenworkControlAction>(() => ({
    ...
    description: "Create or select a OpenWork built-in browser tab, navigate it to a URL, and return the CDP handle for browser automation.",
                          ...
                          <button
                            ...
                            onClick={() => {
                              props.sidebar.onCreateTaskWithPrompt?.(
                                ...
                                "Please summarize the following document for me. Provide the key points, main conclusions, and any action items.\n\n[Paste your document here]",
                              );
                            }}
                          >
                            <FileText size={20} className="mt-0.5 shrink-0 text-dls-secondary" />
                            <div>
                              <div className="text-[13px] font-medium text-dls-text">Summarize a document</div>
                              <div className="mt-0.5 text-[11px] text-dls-secondary">Get key points and action items from any report</div>
                            </div>
                          </button>
                          <button
                            type="button"
                            ...
                            onClick={() => {
                              props.sidebar.onCreateTaskWithPrompt?.(
                                props.selectedWorkspaceId,
                                "Help me draft a professional business report. Please ask me what topic and audience to tailor it for.",
                              );
                            }}
                          >
                            <PenLine size={20} className="mt-0.5 shrink-0 text-dls-secondary" />
                            <div>
                              <div className="text-[13px] font-medium text-dls-text">Draft a report</div>
                              <div className="mt-0.5 text-[11px] text-dls-secondary">Write a professional report on any business topic</div>
                            </div>
                          </button>
                          <button
                            type="button"
                            ...
                            onClick={() => {
                              props.sidebar.onCreateTaskWithPrompt?.(
                                props.selectedWorkspaceId,
                                "I have some data I'd like to analyze. Please help me identify patterns, trends, and key insights.\n\n[Paste your data here]",
                              );
                            }}
                          >
                            <BarChart3 size={20} className="mt-0.5 shrink-0 text-dls-secondary" />
                            <div>
                              <div className="text-[13px] font-medium text-dls-text">Analyze data</div>
                              <div className="mt-0.5 text-[11px] text-dls-secondary">Explore patterns and insights from your data</div>
                            </div>
                          </button>
                        </div>
                      </div>
