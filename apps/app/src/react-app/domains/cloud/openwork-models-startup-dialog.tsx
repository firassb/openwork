    ...
    >
      <DialogContent className="w-full max-w-lg overflow-hidden sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            OpenWork Models gives your workspace hosted frontier models. You can still use your own providers whenever you prefer.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-dls-secondary">
            Pricing is handled through OpenWork. Continue without it to use your own provider keys.
          </p>
        </div>
