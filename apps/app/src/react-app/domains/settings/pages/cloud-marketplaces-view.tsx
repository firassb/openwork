      ...
      {!isSignedIn ? (
        <SettingsNotice>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <span>You can use OpenWork without an account. Sign in to load the Marketplace, including OpenWork's built-in extensions and any organization marketplaces.</span>
