...
const workspaceCards: { tab: SettingsTab; icon: typeof Sparkles; title: string; desc: string }[] = [
  ...
  { tab: "server", icon: Server, title: "OpenWork Server", desc: "Connect to a OpenWork server with URL and token." },
  { tab: "openwork-inference", icon: Zap, title: "OpenWork Inference", desc: "Upstream LLM provider, API key, headers, and model aliases." },
];
