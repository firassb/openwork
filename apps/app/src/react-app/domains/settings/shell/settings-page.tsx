...
export function getSettingsTabDescription(tab: SettingsTab) {
  switch (tab) {
    ...
    case "server":
      return "Connect to a OpenWork server with URL and token";
    case "openwork-inference":
      return "Configure upstream LLM provider, API key, headers, and model aliases";
    case "general":
...
export function getWorkspaceSettingsTabs(): SettingsTab[] {
  return ["preferences", "permissions", "extensions", "advanced", "server", "openwork-inference"];
}
