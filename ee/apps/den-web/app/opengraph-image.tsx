          ...
          <div style={{ display: "flex", flexDirection: "column", width: 580, gap: 24 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                <div style={{ fontSize: 24, fontWeight: 600 }}>OpenWork</div>
              </div>
            </div>
            ...
            <div style={{ fontSize: 24, lineHeight: 1.45, color: "#475569", display: "flex", maxWidth: 520 }}>
              Share setups across your org, keep selected workflows available, and manage OpenWork from app.openworklabs.com.
            </div>
